...
public class CommerceActivity extends AppCompatActivity {
    ...
    Button back_btn,add_btn,close_btn;
    TextView save;
    CardView save_card;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CommerceActivity.this, MainActivity.class);
    ...
    private void saveData() {
        SharedPreferences sharedPreferences = getSharedPreferences("shared preferences commerce", MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        Gson gson = new Gson();
        String json = gson.toJson(mExampleList);
        editor.putString("task list commerce", json);
        editor.apply();
    ...
    private void loadData() {
        SharedPreferences sharedPreferences = getSharedPreferences("shared preferences commerce", MODE_PRIVATE);
        Gson gson = new Gson();
        String json = sharedPreferences.getString("task list commerce", null);

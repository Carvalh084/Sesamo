...
public class BankActivity extends AppCompatActivity {
    ...
    private void saveData() {
        SharedPreferences sharedPreferences = getSharedPreferences("shared preferences bank", MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        Gson gson = new Gson();
        String json = gson.toJson(mExampleList);
        editor.putString("task list bank", json);
        editor.apply();
    ...
    private void loadData() {
        SharedPreferences sharedPreferences = getSharedPreferences("shared preferences bank", MODE_PRIVATE);
        Gson gson = new Gson();
        String json = sharedPreferences.getString("task list bank", null);

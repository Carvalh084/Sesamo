...
public class WifiActivity extends AppCompatActivity {
    ...
    private void saveData() {
        SharedPreferences sharedPreferences = getSharedPreferences("shared preferences wifi", MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        Gson gson = new Gson();
        String json = gson.toJson(mExampleList);
        editor.putString("task list wifi", json);
        editor.apply();
    ...
    private void loadData() {
        SharedPreferences sharedPreferences = getSharedPreferences("shared preferences wifi", MODE_PRIVATE);
        Gson gson = new Gson();
        String json = sharedPreferences.getString("task list wifi", null);
